...
var
  FMDcliepedido: TFMDcliepedido;

implementation

{$R *.DFM}

procedure TFMDcliepedido.FormCreate(Sender: TObject);
begin
  Table1.Open;
  Table2.Open;
end;

procedure TFMDcliepedido.Button1Click(Sender: TObject);
begin
close
end;
